package com.pupukkaltim.pkthighlight.subuser.keuangan.hpp;
...
public class HPP extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfViewa.fromFile(new File(Environment.getExternalStorageDirectory().toString()+"/Download/PKT/Keuangan/HPP.pdf")).load();
    }
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialoga = new ProgressDialog(HPP.this);
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                OutputStream output = new FileOutputStream(root+"/Download/PKT/Keuangan/HPP.pdf");

package com.pupukkaltim.pkthighlight.subuser.produksi.downtime;
...
public class Downtime extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfViewa.fromFile(new File(Environment.getExternalStorageDirectory().toString()+"/Download/PKT/Produksi/Downtime.pdf")).load();
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialoga = new ProgressDialog(Downtime.this);
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                OutputStream output = new FileOutputStream(root+"/Download/PKT/Produksi/Downtime.pdf");

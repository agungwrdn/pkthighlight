package com.pupukkaltim.pkthighlight.subuser.lain.download;
...
public class Download extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfViewa.fromFile(new File(Environment.getExternalStorageDirectory().toString()+"/Download/PKT/Lain/Download Daily Performance.pdf")).load();
    }
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialoga = new ProgressDialog(Download.this);
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                OutputStream output = new FileOutputStream(root+"/Download/PKT/Lain/Download Daily Performance.pdf");

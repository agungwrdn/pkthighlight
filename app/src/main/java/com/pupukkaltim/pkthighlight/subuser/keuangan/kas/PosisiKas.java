package com.pupukkaltim.pkthighlight.subuser.keuangan.kas;
...
public class PosisiKas extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfViewa.fromFile(new File(Environment.getExternalStorageDirectory().toString()+"/Download/PKT/Keuangan/Posisi Kas.pdf")).load();
    }
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialoga = new ProgressDialog(PosisiKas.this);
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                OutputStream output = new FileOutputStream(root+"/Download/PKT/Keuangan/Posisi Kas.pdf");
